...
public class Database implements Runnable {
    ...
    private void connectToDb() {
        try {
            databaseConnection = DriverManager.getConnection("jdbc:mysql://85.30.179.54:3306/auction?user=secretlogin&password=password1234&useSSL=false&serverTimezone=UTC");
